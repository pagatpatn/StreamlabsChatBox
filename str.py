...
SEND_DELAY = int(os.getenv("MESSAGE_DELAY", 5))  # seconds between sending each queued message
...
POLL_INTERVAL = 5       # Kick API poll interval
TIME_WINDOW_MINUTES = 0.1  # how far back to fetch Kick messages
...
def extract_emoji(text: str) -> str:
    """Replace Kick emotes with emoji"""
...
async def run_browser():
    async with async_playwright() as p:
        ...
        await asyncio.Future()  # keep browser running
